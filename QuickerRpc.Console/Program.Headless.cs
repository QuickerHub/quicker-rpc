...
internal static partial class Program
{
    ...
    private static async Task<int> RunStepRunnerGetAsync(StepRunnerOptions options)
    {
        ...
        try
        {
            ...
            {
                global::System.Console.WriteLine(JsonSerializer.Serialize(
                    new { ok = response.Success, action = "step-runner-get", pipe = QuickerRpcPipeNames.ServerPipe, payload },
                    QkrpcJson.CliOutput));
            }
            else
            {
    ...
    private static async Task<int> RunActionGetAsync(ActionOptions options)
    {
        ...
        try
        {
            ...
            {
                global::System.Console.WriteLine(JsonSerializer.Serialize(
                    new { ok = response.Success, action = "get", pipe = QuickerRpcPipeNames.ServerPipe, payload },
                    QkrpcJson.CliOutput));
            }
            else
            {
    ...
    private static async Task<int> RunActionPatchAsync(ActionOptions options)
    {
        ...
        try
        {
            ...
            {
                global::System.Console.WriteLine(JsonSerializer.Serialize(
                    new { ok = response.Success, action = "patch", pipe = QuickerRpcPipeNames.ServerPipe, payload },
                    QkrpcJson.CliOutput));
            }
            else
            {
    ...
    private static void WriteRpcJson(bool json, string action, bool success, object payload)
    {
        ...
        {
            global::System.Console.WriteLine(JsonSerializer.Serialize(
                new { ok = success, action, pipe = QuickerRpcPipeNames.ServerPipe, payload },
                QkrpcJson.CliOutput));
        }
        else
        {
