...
function dispatchSseBlock(block: string, handlers: ActionTraceSseHandlers): void {
...
function drainSseBuffer(buffer: string, handlers: ActionTraceSseHandlers): string {
  let rest = buffer;
...
/** Read an SSE response with fetch (streams incrementally; works with qkrpc serve GET). */
