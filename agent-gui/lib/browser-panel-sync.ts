...
/** Extract panel fields from a browser tool structured result payload. */
export function browserPanelPatchFromToolOutput(
  ...
  const previewBase64 = pickString(data, "previewBase64");
  if (previewBase64) {
    patch.previewBase64 = previewBase64;
    patch.previewMimeType = pickString(data, "previewMimeType") ?? "image/jpeg";
  }
