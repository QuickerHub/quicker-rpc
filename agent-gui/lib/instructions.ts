...
- Quicker app settings / UI: quicker_settings({ action: "search"|"get"|"set"|"pages"|"open" }). Open recycle bin: action=open, page=recycle-bin or 动作回收站 — NOT action list scope. See docs get topic quicker-ui.
