...
export const SYSTEM_INSTRUCTIONS = prompt(
  ...
  "",
  "## Communication",
  "- **Language**: Match the user's language for every user-visible sentence (status lines between tools included). Default Chinese when unclear.",
  "- **Never mix languages** in one turn or consecutive assistant lines (e.g. English setup then Chinese summary).",
  "- Reply in the user's language; never expose tool names, CLI, or JSON shapes in user-facing text.",
