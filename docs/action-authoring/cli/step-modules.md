...
| `kc/evalexpression` | `sys:evalexpression` | Evaluate C# expression / LINQ / assign ({var}=value); preferred over assign & compute steps | [expression](https://getquicker.net/KC/Help/Doc/expression) |
