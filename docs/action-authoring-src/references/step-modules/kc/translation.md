...
> **分类**：文本处理 · **来源**：KC 官方文档（`npm run docs:modules:gen`）· [translation](https://getquicker.net/KC/Help/Doc/translation)

**用途**：Machine translation via third-party APIs (paid feature)
...
- 2021年7月23日起：官网续费/购买专业版，赠送实际支付金额的 5% Q豆数量。
