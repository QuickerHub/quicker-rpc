...
> **分类**：系统与窗口 · **来源**：KC 官方文档（`npm run docs:modules:gen`）· [activateprocessmainwindow](https://getquicker.net/KC/Help/Doc/activateprocessmainwindow)

**用途**：Bring process main window to front
