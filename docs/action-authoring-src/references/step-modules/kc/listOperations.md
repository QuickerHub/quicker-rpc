...
> **分类**：计算与数据结构 · **来源**：KC 官方文档（`npm run docs:modules:gen`）· [listoperations](https://getquicker.net/KC/Help/Doc/listoperations)

**用途**：List step UI modes (prefer sys:evalexpression for LINQ; search 列表操作 for this module)
