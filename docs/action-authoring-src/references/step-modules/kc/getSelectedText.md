...
> **分类**：常用基础 · **来源**：KC 官方文档（`npm run docs:modules:gen`）· [get_selected_text](https://getquicker.net/KC/Help/Doc/get_selected_text)

**用途**：Get currently selected text
...
有许多情况可能导致获取选中文本失败，请参考：[https://getquicker.net/kc/help/doc/cannot_get_selected_text](https://getquicker.net/kc/help/doc/cannot_get_selected_text)
