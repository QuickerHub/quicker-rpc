...
| **M** | 35–55 | 多 controlField / 多操作类型（`http`、`form`、`fileOperation`） | + 模式、示例 |
| **L** | 55–90 | 重协议 / 外链大段正文（`csscript`、`webview2`、`excelreadwrite`、`inputScript`） | + 协议；lint 按需 |
