...
> **分类**：文本处理 · **官方**：[stringprocess](https://getquicker.net/KC/Help/Doc/stringprocess)

**用途**：Built-in string operations (prefer sys:evalexpression for logic; search 文本处理 to use this module)

**勿用于**：linq、expression、表达式、assign（见 `expressions` / `implementation-fallback`）
