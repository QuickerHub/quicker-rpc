...
> **分类**：图片 · **来源**：KC 官方文档（`npm run docs:modules:gen`）· [searchbmp](https://getquicker.net/KC/Help/Doc/searchbmp)

**用途**：Find image/color/text on screen
...
- 您也可以使用Cesaryuan网友分享的子程序进行找图。该子程序具有更高的容错表现。网址为：https://getquicker.net/SubProgram?id=e4af1d5b-143b-4b62-4de5-08d85ac8eddb
...
- 增加“颜色容差”的数值。
- 使用找图增强版子程序：：https://getquicker.net/SubProgram?id=e4af1d5b-143b-4b62-4de5-08d85ac8eddb
...
使用 Windows内置OCR引擎+ [Quicker离线OCR引擎](https://getquicker.net/KC/Help/Doc/basic-ocr#ephSZ) 进行查找。
