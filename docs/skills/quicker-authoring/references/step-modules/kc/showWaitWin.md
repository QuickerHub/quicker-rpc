...
> **分类**：界面交互 · **来源**：KC 官方文档（`npm run docs:modules:gen`）· [showwaitwin](https://getquicker.net/KC/Help/Doc/showwaitwin)

**用途**：Show wait-for-user-operation window
...
- [fa:Light_Pen:#99AAFF]按钮标题(Tooltip文字内容)
