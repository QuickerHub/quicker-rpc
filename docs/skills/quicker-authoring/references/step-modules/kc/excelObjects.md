...
> **分类**：第三方软件 · **来源**：KC 官方文档（`npm run docs:modules:gen`）· [excelobjects](https://getquicker.net/KC/Help/Doc/excelobjects)
...
- 自动生成乘法口诀，写入d:\test.xlsx文件。https://getquicker.net/sharedaction?code=8a38e78c-2edf-4c8b-1506-08d8255d6cc9
- 打开Excel文件：https://getquicker.net/sharedaction?code=efa8a4af-4a87-4d52-d718-08d827485760
- 选择工作表：https://getquicker.net/sharedaction?code=5a3e75ce-5a1c-4d1d-d71a-08d827485760
