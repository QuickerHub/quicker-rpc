...
> **分类**：系统与窗口 · **来源**：KC 官方文档（`npm run docs:modules:gen`）· [getselectedfiles](https://getquicker.net/KC/Help/Doc/getselectedfiles)

**用途**：Get selected files/folders from Explorer or desktop
