...
> **分类**：文件与目录 · **来源**：KC 官方文档（`npm run docs:modules:gen`）· [checkpathexists](https://getquicker.net/KC/Help/Doc/checkpathexists)

**用途**：Check if file/folder exists; optional file metadata
...
- "属性名": 属性值
- "属性名_FriendlyName": 属性名的友好名（通常是中文）
