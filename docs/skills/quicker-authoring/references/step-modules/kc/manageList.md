...
> **分类**：计算与数据结构 · **来源**：KC 官方文档（`npm run docs:modules:gen`）· [managelist](https://getquicker.net/KC/Help/Doc/managelist)

**用途**：Manually sort/edit list in UI
...
“显示内容提取表达式”用于对列表的每一项进行转换，得到显示标题。其写法类似于[普通表达式](https://getquicker.net/kc/help/doc/expression)，但是有如下的区别：
