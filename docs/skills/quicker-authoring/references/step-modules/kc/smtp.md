...
> **分类**：网络与云服务 · **来源**：KC 官方文档（`npm run docs:modules:gen`）· [smtp](https://getquicker.net/KC/Help/Doc/smtp)

**用途**：Send email via SMTP
...
- 发送到QQ邮箱 https://getquicker.net/sharedaction?code=4943c94a-0437-4b98-20f1-08d742f11f76

# 参考信息

- 常用邮箱的SMTP服务器信息：https://blog.csdn.net/ning521513/article/details/79217203
