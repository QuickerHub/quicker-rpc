...
> **分类**：计算与数据结构 · **来源**：KC 官方文档（`npm run docs:modules:gen`）· [numberprocess](https://getquicker.net/KC/Help/Doc/numberprocess)

**用途**：Format or convert numbers (to text, rounding, etc.)
