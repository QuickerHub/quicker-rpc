...
> **分类**：网络与云服务 · **来源**：KC 官方文档（`npm run docs:modules:gen`）· [webview2](https://getquicker.net/KC/Help/Doc/webview2)
...
- https://getquicker.net/sharedaction?code=a6fd6ca9-b6d8-4fbf-afe2-08d8f6743496 （搜索Quicker网站）
- https://getquicker.net/sharedaction?code=0b13fc42-ada7-4bb0-afe3-08d8f6743496 (有道翻译）
