...
> **分类**：计算与数据结构 · **来源**：KC 官方文档（`npm run docs:modules:gen`）· [dictoperations](https://getquicker.net/KC/Help/Doc/dictoperations)

**用途**：Dictionary step (prefer sys:evalexpression for logic; search 词典 for this module)
