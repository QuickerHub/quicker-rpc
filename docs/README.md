...
| [../voice-asr-runtime/README.md](../voice-asr-runtime/README.md) | Local ASR runtime server (Python, quicker-voice-v1) |
| [action-authoring-src/](action-authoring-src/) | **Source** templates + `manifest/*.json` (CLI vs agent-ui) |
