...
/// </summary>
public sealed class QuickerRpcServerHost : IHostedService
{
    private readonly IQuickerRpcService _service;
    private readonly ILogger<QuickerRpcServerHost> _logger;
    ...
    public QuickerRpcServerHost(IQuickerRpcService service, ILogger<QuickerRpcServerHost> logger)
    {
        _service = service;
        _logger = logger;
    }
    ...
    private async Task RunAsync(CancellationToken cancellationToken)
    {
        ...
        while (!cancellationToken.IsCancellationRequested)
        {
            ...
            try
            {
                pipeStream = QuickerRpcPipeServerStreamFactory.Create(pipeName);
